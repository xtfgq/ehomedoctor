...
public class DownloadServiceForAPK extends Service {
    ...
    // 返回的安装包url
    private String apkUrl = Constans.DOWNLOADURL;
    // private String apkUrl = MyApp.downloadApkUrl;
    /* 下载包安装路径 */
    private static final String savePath = "/sdcard/ehomedoctor/";

    private static final String saveFileName = savePath + "ehomedoctor.apk";
    // private MyApp app;
