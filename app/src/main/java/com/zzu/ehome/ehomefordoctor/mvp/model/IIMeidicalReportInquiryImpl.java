...
import com.zzu.ehome.ehomefordoctor.mvp.listener.IMeidicalReportInquiry;
...
public class IIMeidicalReportInquiryImpl implements IMeidicalReportInquiry {
    public RequestManager manager;

    public IIMeidicalReportInquiryImpl(){
        manager= RequestManager.getInstance();
    }
    @Override
    public void MeidicalReportInquiry(String userid, final OnCommonResultListener listener) {
