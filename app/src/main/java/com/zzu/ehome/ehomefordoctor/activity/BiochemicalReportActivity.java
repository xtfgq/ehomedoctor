...
public class BiochemicalReportActivity extends BaseActivity implements InspectionReportView {
    ...
    public <T> void onSuccess(T t) {
        ...
        if ((List<ResultContent>) t != null && ((List<ResultContent>) t).size() > 0) {
            ...
            if (isFirst) {
                adapter = new InspectionReportAdapter(BiochemicalReportActivity.this, mList);
    ...
    public void onError() {
        progressStateLayout.showError(new ProgressStateLayout.ReloadListener() {
            ...
            public void onClick() {
                ...
                isLoading = false;
                if (presenter == null) {
                    presenter = new InspectionReportPresenter(BiochemicalReportActivity.this);
                }
                presenter.getInspectionReport();
            }
        });
